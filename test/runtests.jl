...
@testitem "Test symbolic derivatives" begin
    ...
    using DynamicExpressions:
        Expression, Node, OperatorEnum, @declare_expression_operator, AbstractExpression
...
@testitem "Test special functions and their derivatives" begin
    ...
    using DynamicExpressions:
        Expression, Node, OperatorEnum, AbstractExpression, @declare_expression_operator
